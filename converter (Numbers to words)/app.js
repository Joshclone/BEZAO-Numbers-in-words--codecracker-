...
/**
 * @author Nwaeze Joshua <nwaezejoshua@gmail.com>
 ...
 */
 ...
 $(document).ready(function(){
    ...
    //here's the upper limit for the number
    let numLimit = 1000000000000;

    //here's the final text result of the number
    let numText = " "  ;
    ...
    form.submit(function(e){
        ...
        $("#convertNum").html("Converted Number: " + finalNumText + `  Naira`);
    });
    ...
    /**
     *Here this converts any three digit number into text
    ...
    /**
     * This function converts any two digit number into text
     * @param {the number to convert} num 
     */
